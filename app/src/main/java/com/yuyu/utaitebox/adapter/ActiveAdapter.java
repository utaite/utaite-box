...
public class ActiveAdapter extends RecyclerView.Adapter<ActiveAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        requestManager.load(url + (avatar == null ? context.getString(R.string.rest_profile) : avatar))
        ...
        if (cover == null) {
            ...
            requestManager.load(RestUtils.BASE + context.getString(R.string.rest_profile_cover) + cover)
                    .diskCacheStrategy(DiskCacheStrategy.SOURCE)
                    .into(holder.nav_bg1);
        }
    }
